package com.bewg.pd.common.system.query;
...
import com.bewg.pd.common.util.SqlInjectionUtil;
import com.bewg.pd.common.util.WorkBookDataAutorUtils;
...
public class QueryGenerator {
     ...
     * 错误示例:如QueryWrapper<Demo> queryWrapper = new QueryWrapper<Demo>(Demo); <br>
     * 正确示例:QueryWrapper<Demo> queryWrapper = new QueryWrapper<Demo>(); <br>
    ...
    public static void installMplus(QueryWrapper<?> queryWrapper, Object searchObj, Map<String, String[]> parameterMap) {
        ...
        */
        ...
        // if(StringUtils.isNotBlank(c) && c.startsWith(SQL_RULES_COLUMN)){
    ...
    public static void doSuperQuery(QueryWrapper<?> queryWrapper, Map<String, String[]> parameterMap) {
        if (parameterMap != null && parameterMap.containsKey(SUPER_QUERY_PARAMS)) {
            ...
            for (QueryCondition rule : conditions) {
                if (StringUtils.isNotBlank(rule.getField()) && StringUtils.isNotBlank(rule.getRule()) && StringUtils.isNotBlank(rule.getVal())) {
    ...
    public static Map<String, SysPermissionDataRule> getRuleMap() {
        ...
        List<SysPermissionDataRule> list = WorkBookDataAutorUtils.loadDataSearchConditon();
